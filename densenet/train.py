...
dataset = dataloader(training_csv, training_data, preproc())
a = DataLoader(dataset=dataset, batch_size=5, shuffle=True, num_workers=0)
trainimages, trainlabels = next(iter(a))

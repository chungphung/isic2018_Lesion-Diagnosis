...
from preprocess import preproc, lowcost_16crop_preproc
...
validation = dataloader(validate_csv, data, lowcost_16crop_preproc(), 'validate')
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            if phase == 'train':
                ...
                batch_iterator = iter(DataLoader(
                    dataloaders[phase], 1, shuffle=False, num_workers=20))
...
#     exp_lr_scheduler = None
    model_ft = train_model(model_ft, criterion, optimizer_ft, exp_lr_scheduler,
                           writer, model_name, batch_size=14, arccos=arccos, num_epochs=100, alpha=0.1)
